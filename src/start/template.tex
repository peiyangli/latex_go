%指示样式模板 % 17pt,twoside,a4paper
\documentclass[wcp,10pt]{jmlr} 

%引用的宏包
\usepackage{longtable}
\usepackage{booktabs}
% \usepackage{tabularx, makecell, multirow}
\usepackage{syntonly} %可令 LATEX 编译后不生成 DVI 或者 PDF 文档，只排查错误，
% \syntaxonly %如果想生成文档，则用 % 注释掉 \syntaxonly 命令即可。
